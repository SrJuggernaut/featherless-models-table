import columns from '@/components/newModelsTable/Columns'
...
import ColumnFilter from './newModelsTable/ColumnFilter'
import { Button } from './ui/button'
import { DropdownMenu, DropdownMenuCheckboxItem, DropdownMenuContent, DropdownMenuTrigger } from './ui/dropdown-menu'
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from './ui/select'

export interface NewModelsTableProps {
  items: NewModelItem[]
}

const NewModelsTable: FC<NewModelsTableProps> = ({ items: data }) => {
  const [sorting, setSorting] = useState<SortingState>([])
  const [columnFilters, setColumnFilters] = useState<ColumnFiltersState>([])
  const [columnVisibility, setColumnVisibility] = useState<VisibilityState>({ owned_by: false, is_gated: false })

  const table = useReactTable<NewModelItem>({
    data,
    columns,
